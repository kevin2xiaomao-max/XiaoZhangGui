...
enum V32Layout {
    ...
    /// Shared reservation for the floating system tab bar on iOS 26+.
    /// This is a layout component height, not a device-specific safe-area value.
    static let floatingTabBarReservation: CGFloat = 72
